            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('orders.index') }}" class="list-group-item list-group-item-action active">Quản lý đơn hàng</a>
                            ...
                            @foreach($orders as $order)
                                ...
                                <div class="accordion-item mb-3 border rounded overflow-hidden">
                                    <h2 class="accordion-header" id="heading-{{ $order->id }}">
                                        <button class="accordion-button collapsed fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-{{ $order->id }}" aria-expanded="false" aria-controls="collapse-{{ $order->id }}">
                                            <div class="w-100 d-flex flex-wrap justify-content-between align-items-center gap-2">
                                                ...
                                                <span class="badge {{ $order->is_paid === 'paid' ? 'bg-success' : 'bg-warning text-dark' }}">{{ $order->is_paid === 'paid' ? 'Đã thanh toán' : 'Chưa thanh toán' }}</span>
                                    ...
                                    <div id="collapse-{{ $order->id }}" class="accordion-collapse collapse" aria-labelledby="heading-{{ $order->id }}" data-bs-parent="#ordersAccordion">
                                        <div class="accordion-body bg-white">
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="p-3 border rounded bg-light h-100">
                                                        <div class="fw-bold mb-2">Thông tin đơn</div>
                                                ...
                                                <table class="table align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        @foreach($order->products as $product)
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <img src="{{ $imageUrl }}" alt="{{ $product->name }}" class="rounded border" style="width:60px;height:60px;object-fit:cover;">
                                                                </td>
                                                                <td>
