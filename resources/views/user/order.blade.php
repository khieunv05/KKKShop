                        ...
                        <div class="p-3 border-bottom d-flex align-items-center">
                            <div class="me-2">
                                <span
                                    ...
                                    style="width:40px;height:40px;">{{ strtoupper(substr(auth()->user()->name ?? 'U', 0, 1)) }}</span>
                            </div>
                            <div>
                                        ...
                                        <h2 class="accordion-header" id="heading-{{ $order->id }}">
                                            <button class="accordion-button collapsed fw-semibold" type="button"
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="badge {{ $order->is_paid === 'paid' ? 'bg-success' : 'bg-warning text-dark' }}">{{ $order->is_paid === 'paid' ? 'Đã thanh toán' : 'Chưa thanh toán' }}</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="p-3 border rounded bg-light h-100">
                                                            ...
                                                            <div class="d-flex justify-content-between mb-1"><span>Tình
                                                                    trạng</span><span
                                                                    class="text-uppercase">{{ $order->status }}</span></div>
                                                            <div class="d-flex justify-content-between mb-1"><span>Thanh
                                                                    toán</span><span>{{ $order->is_paid === 'paid' ? 'Đã thanh toán' : 'Chưa thanh toán' }}</span>
                                                            </div>
