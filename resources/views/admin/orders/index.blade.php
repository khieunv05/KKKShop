...
<div class="container mt-4">
    ...
    <div class="tab-content mt-3">
        @foreach(['pending' => $pending, 'shipping' => $shipping, 'completed' => $completed, 'cancelled' => $cancelled] as $tab => $orders)
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modal{{$order->id}}">Chi tiết</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                    ...
                    <table class="table table-bordered mb-0">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <th class="text-end text-danger">{{ number_format($total + $order->shipping_fee, 0, ',', '.') }} ₫</th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
